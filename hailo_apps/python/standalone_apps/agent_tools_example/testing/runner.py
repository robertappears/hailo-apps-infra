...
Usage:
    ...
    python -m hailo_apps.python.standalone_apps.agent_tools_example.testing.runner math

    # Run quick test (3 tests)
    python -m hailo_apps.python.standalone_apps.agent_tools_example.testing.runner math --quick

    # Filter by tags
    python -m hailo_apps.python.standalone_apps.agent_tools_example.testing.runner math --tags basic

    # Save results
    python -m hailo_apps.python.standalone_apps.agent_tools_example.testing.runner math --output results.json
"""
